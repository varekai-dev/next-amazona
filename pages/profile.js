...
import { Grid, Typography, List, ListItem, TextField, Button, ListItemText, Card } from '@material-ui/core';
									...
									<List>
										...
										<ListItem>
											<Controller
												...
												control={control}
												defaultValue=""
												rules={{ validate: (value) => value === '' || value.length > 5 || 'Password length is more than 5' }}
												render={({ field }) => (
													<TextField
										...
										<ListItem>
											<Controller
												...
												control={control}
												defaultValue=""
												rules={{ validate: (value) => value === '' || value.length > 5 || 'Confirm password length is more than 5' }}
												render={({ field }) => (
													<TextField
