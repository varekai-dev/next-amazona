import { Grid, List, ListItem, Box, Typography, Select, MenuItem, Button } from '@material-ui/core';
...
export default function Search(props) {
	...
	return (
		<Layout title="Search">
			<Grid className={s.m1} container spacing={1}>
				<Grid item md={3} xs={6}>
					<List>
						<ListItem>
				...
				<Grid item md={9}>
					<Grid container justifyContent="space-between" alignItems="center">
						...
						<Grid item>
							<Typography component="span" className={s.sort}>
								Sort by
							</Typography>
							<Select value={sort} onChange={sortHandler}>
								...
								<MenuItem value="newsest">Newsest Arrivals</MenuItem>
							</Select>
						</Grid>
					</Grid>
					<Grid className={s.mt1} container spacing={3}>
					...
					<Pagination className={s.mt1} defaultPage={parseInt(query.page || '1')} count={pages} onChange={pageHandler}></Pagination>
				</Grid>
			</Grid>
		</Layout>
	);
